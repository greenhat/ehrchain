...
dependencyOverrides in ThisBuild ++= Seq(
  ...
  "com.typesafe.akka" % "akka-actor-typed_2.12" % "2.5.12",
  ...
  "com.typesafe.akka" % "akka-testkit_2.12" % "2.4.20",
...
// LIBRARY_DEPENDENCIES_HASH d459bee504a720b14eeafd6cd9c1e5dfe3ad1339
